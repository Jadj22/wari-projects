...
export default function CreateGamePage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const [gameTypesResponse, countriesResponse] = await Promise.all([
        ...
        return (
            <div className="flex items-center justify-center min-h-screen bg-gray-100">
                <div className="text-center">
                    ...
                    <p className="mt-2">Seuls les administrateurs et éditeurs peuvent créer des jeux.</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="p-6 max-w-2xl mx-auto">
            <h1 className="text-2xl font-bold mb-6">Créer un jeu</h1>
